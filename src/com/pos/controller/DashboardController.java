...
public class DashboardController implements Initializable {
    ...
    private void showTransactions() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/pos/view/transactions-home.fxml"));
    ...
    private void showProducts() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/pos/view/products.fxml"));
            Stage stage = (Stage) welcomeLabel.getScene().getWindow();
            Scene scene = new Scene(root);
            scene.getStylesheets().add(getClass().getResource("/styles/dashboard.css").toExternalForm());
            stage.setScene(scene);
            ...
            e.printStackTrace();
            showAlert("Navigation Error", "Failed to load Products page: " + e.getMessage());
        }
    }
    ...
    private void showCustomers() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/pos/view/customers.fxml"));
            Stage stage = (Stage) welcomeLabel.getScene().getWindow();
            Scene scene = new Scene(root);
            scene.getStylesheets().add(getClass().getResource("/styles/dashboard.css").toExternalForm());
            stage.setScene(scene);
            ...
            e.printStackTrace();
            showAlert("Navigation Error", "Failed to load Customers page: " + e.getMessage());
        }
    }
...
//        try {
//            Parent root = FXMLLoader.load(getClass().getResource("/com/pos/view/settings.fxml"));
//            Stage stage = (Stage) welcomeLabel.getScene().getWindow();
...
//        } catch (Exception e) {
//            e.printStackTrace();
//            showAlert("Navigation Error", "Failed to load Settings page: " + e.getMessage());
//        }
    }
    @FXML
